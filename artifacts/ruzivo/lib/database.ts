...
const SEED_PLANTS: Plant[] = [
  ...
  {
    id: "black-seed",
    name_common: "Black Seed",
    name_scientific: "Nigella sativa",
    image_url: null,
    safety_status: "Caution",
    uses: ["Immune system support", "Respiratory health", "Anti-inflammatory", "Digestive aid", "Skin conditions and eczema"],
    warnings: ["Avoid large doses during pregnancy", "Can interact with blood-thinning medications", "Not recommended for children under 2", "May lower blood pressure"],
    traditional_uses: ["Used in North and East African traditional medicine for centuries", "Seeds mixed with honey for respiratory ailments", "Applied as oil to scalp for hair growth", "Used in Islamic prophetic medicine — called 'Habbatus Sauda'"],
    local_names: { Arabic: "Habbatus Sauda", Amharic: "Tikur azmud", Swahili: "Mbegu nyeusi", Egyptian: "Habbet el baraka" },
  },
  {
    id: "turmeric",
    name_common: "Turmeric",
    name_scientific: "Curcuma longa",
    image_url: null,
    safety_status: "Safe",
    uses: ["Anti-inflammatory joint support", "Digestive health", "Liver support", "Wound healing", "Skin brightening"],
    warnings: ["High doses may cause stomach upset", "Avoid before surgery — mild blood-thinning effect", "Can stain skin and fabrics yellow", "May interact with diabetes medications"],
    traditional_uses: ["Traded along East African coast via Indian Ocean routes", "Used in coastal communities for inflammation and fever", "Applied as paste to wounds and skin irritations", "Added to food as both spice and preventive medicine"],
    local_names: { Swahili: "Manjano", Afrikaans: "Borrie", Arabic: "Kurkum", Zulu: "uPhela" },
  },
  {
    id: "ginger",
    name_common: "Ginger",
    ...
    image_url: null,
    safety_status: "Safe",
    uses: ["Nausea and vomiting relief", "Digestive aid", "Anti-inflammatory", "Cold and flu relief", "Improved circulation"],
    warnings: ["Large amounts may cause heartburn", "Avoid before surgery — mild blood-thinning effect", "Rare allergic reactions possible", "May interact with anticoagulant drugs"],
    traditional_uses: ["Traded along East African coast for centuries", "Used in Swahili coastal medicine for stomach ailments", "Combined with lemon and honey for respiratory infections", "Used in West Africa for headaches and muscle pain"],
    local_names: { Swahili: "Tangawizi", Afrikaans: "Gemmer", Zulu: "uSingolwane", Hausa: "Citta" },
  },
  {
    id: "shea-tree",
    name_common: "Shea Tree",
    name_scientific: "Vitellaria paradoxa",
    image_url: null,
    safety_status: "Safe",
    uses: ["Skin moisturising and healing", "Hair conditioning", "Anti-inflammatory (shea butter)", "Cooking fat source", "Wound and burn care"],
    warnings: ["Possible nut allergy in sensitive individuals", "Use raw shea butter with caution if latex-allergic", "Some people experience skin breakouts from heavy application"],
    traditional_uses: ["Sacred tree in West and Central Africa — never cut down", "Shea butter produced by women's cooperatives for generations", "Used across the Sahel for cooking, medicine, and cosmetics", "Butter applied to newborns' skin in many communities"],
    local_names: { Hausa: "Kadanya", Yoruba: "Ori", Bambara: "Shi", Dioula: "Si" },
  },
  {
    id: "bitter-kola",
    name_common: "Bitter Kola",
    name_scientific: "Garcinia kola",
    image_url: null,
    safety_status: "Caution",
    uses: ["Antibacterial properties", "Immune system support", "Respiratory health", "Antiviral activity", "Anti-inflammatory"],
    warnings: ["High consumption may increase heart rate", "Avoid with hypertension medication", "Not recommended during pregnancy", "Excessive use may cause insomnia"],
    traditional_uses: ["Sacred in West and Central African ceremonies and hospitality", "Offered to elders and guests as a sign of respect", "Used by Yoruba and Igbo healers for infections and coughs", "Chewed before meals to stimulate digestion"],
    local_names: { Yoruba: "Orogbo", Hausa: "Namijin Goro", Igbo: "Oji Ibo", Efik: "Efiari" },
  },
  {
    id: "soursop",
    name_common: "Soursop",
    name_scientific: "Annona muricata",
    image_url: null,
    safety_status: "Caution",
    uses: ["Immune system support", "Fever and infection relief", "Digestive health", "Relaxation and sleep support", "Anti-inflammatory"],
    warnings: ["Seeds are toxic — never consume seeds", "May significantly lower blood pressure", "Avoid in Parkinson's disease — may worsen symptoms", "Not recommended during pregnancy"],
    traditional_uses: ["Used across tropical Africa for fever and infections", "Leaves boiled for tea as a relaxation and sleep remedy", "Fruit pulp given to children with fever", "Bark and roots used in some West African traditions for worms"],
    local_names: { Swahili: "Mstafeli", Hausa: "Gwanda", Yoruba: "Eko Erin", Afrikaans: "Suurkweper" },
  },
  {
    id: "lemongrass",
    name_common: "Lemongrass",
    name_scientific: "Cymbopogon citratus",
    image_url: null,
    safety_status: "Safe",
    uses: ["Digestive health and bloating", "Antimicrobial activity", "Anxiety and stress relief", "Fever reduction", "Skin and hair care"],
    warnings: ["May cause skin irritation when used undiluted as essential oil", "Avoid large quantities during pregnancy", "Possible allergy in sensitive individuals"],
    traditional_uses: ["Used across tropical Africa in both cooking and healing", "Tea prepared for stomach aches, colds, and headaches", "Burned as natural insect repellent in many communities", "Leaves used in steam inhalation for sinus and respiratory relief"],
    local_names: { Swahili: "Mchaichai", Hausa: "Tafasa", Yoruba: "Kooko oba", Zulu: "uMathandwa" },
  },
  {
    id: "guava",
    name_common: "Guava",
    name_scientific: "Psidium guajava",
    image_url: null,
    safety_status: "Safe",
    uses: ["Diarrhoea and dysentery treatment (leaves)", "Immune system boost (vitamin C)", "Anti-inflammatory", "Blood sugar regulation support", "Dental and gum health"],
    warnings: ["Excessive fruit consumption may cause constipation", "Seeds can irritate sensitive digestive tracts", "Leaf tea should not replace medical treatment for severe diarrhoea"],
    traditional_uses: ["Leaves boiled and drunk for stomach problems across Africa", "Used in East and West Africa for skin infections (leaf paste)", "Children given leaf tea for fever reduction", "Young leaves chewed for toothache relief"],
    local_names: { Swahili: "Mapera", Afrikaans: "Koejawel", Zulu: "iGuava", Hausa: "Gwaeba" },
  },
  {
    id: "tamarind",
    name_common: "Tamarind",
    name_scientific: "Tamarindus indica",
    image_url: null,
    safety_status: "Safe",
    uses: ["Digestive laxative", "Fever cooling agent", "Anti-inflammatory", "Wound and skin care", "Culinary souring agent"],
    warnings: ["Avoid excessive amounts when taking aspirin or blood thinners", "Can cause loose stools in large quantities", "Very sour — may aggravate acid reflux"],
    traditional_uses: ["Native to East Africa — one of Africa's original trees", "Used across the continent for centuries in food and medicine", "Pulp dissolved in water for heat exhaustion and fever", "Seeds ground and applied to sores and inflammations"],
    local_names: { Swahili: "Ukwaju", Arabic: "Tamr Hindi", Hausa: "Tsamiya", Amharic: "Hmer" },
  },
  {
    id: "agave",
    name_common: "Agave",
    name_scientific: "Agave americana",
    image_url: null,
    safety_status: "Caution",
    uses: ["Wound dressing (sap)", "Antimicrobial skin application", "Fiber for rope and craft", "Fermented drink production"],
    warnings: ["Raw sap can cause severe skin and eye irritation", "Not for internal use without proper preparation", "Toxic to pets and livestock", "Sap may trigger allergic reaction"],
    traditional_uses: ["Introduced to Africa from Americas but widely adopted", "Sap used in some communities for wound sealing", "Leaves used to extract strong fiber for rope and craft", "Fermented sap consumed as traditional beverage in some regions"],
    local_names: { Afrikaans: "Garingboom", Zulu: "iGaringboom", Swahili: "Mkonge mkubwa", English: "Century Plant" },
  },
  {
    id: "pelargonium",
    name_common: "Pelargonium",
    name_scientific: "Pelargonium sidoides",
    image_url: null,
    safety_status: "Safe",
    uses: ["Respiratory infection support", "Bronchitis and cough relief", "Sore throat treatment", "Immune stimulation", "Common cold reduction"],
    warnings: ["Rare liver side effects with very prolonged high-dose use", "Avoid in autoimmune conditions such as lupus or MS", "Not well studied in children under 6"],
    traditional_uses: ["Used by Zulu and Basotho traditional healers for chest conditions", "Root preparations used for tuberculosis treatment historically", "Introduced to European medicine by European travellers in the 1800s", "Known as Umckaloabo in Zulu — means 'heavy cough'"],
    local_names: { Zulu: "Umckaloabo", Sotho: "Khoabo", Afrikaans: "Rabassam", English: "African Geranium" },
  },
  {
    id: "hoodia",
    name_common: "Hoodia",
    name_scientific: "Hoodia gordonii",
    image_url: null,
    safety_status: "Caution",
    uses: ["Appetite suppression", "Thirst suppression during hunting", "Endurance support in arid conditions"],
    warnings: ["Can dangerously mask thirst and hunger — risk of dehydration", "Not safe for people with malnutrition or eating disorders", "Limited human clinical research available", "Not recommended without medical supervision"],
    traditional_uses: ["Used by San Bushmen (Khoisan people) on long hunts", "Stalks chewed to suppress hunger and thirst for days", "Knowledge of Hoodia was held as a San survival secret for centuries", "One of the oldest documented African medicinal plants in use"],
    local_names: { Afrikaans: "Bobbejaanghaap", San: "Xhoba", English: "Bushman's Hat", Nama: "Ghaap" },
  },
  {
    id: "sausage-tree",
    name_common: "Sausage Tree",
    name_scientific: "Kigelia africana",
    image_url: null,
    safety_status: "Caution",
    uses: ["Skin conditions and wounds (bark extract)", "Antimicrobial properties", "Rheumatism treatment", "Toothache relief", "Skin cancer research interest"],
    warnings: ["Raw fruit is toxic — must be dried, fermented or cooked before any use", "Never eat raw fruit — causes blistering and vomiting", "Topical preparations should be used with care on sensitive skin"],
    traditional_uses: ["Bark used by traditional healers across Central and East Africa", "Fruit dried and used in traditional beer fermentation", "Applied topically in many communities for skin diseases", "Used in Southern Africa for eczema, psoriasis, and boils"],
    local_names: { Zulu: "Umvongotsi", Shona: "Muvonde", Swahili: "Mwegea", Afrikaans: "Worsboom" },
  },
  {
    id: "jackalberry",
    name_common: "Jackalberry",
    name_scientific: "Diospyros mespiliformis",
    image_url: null,
    safety_status: "Safe",
    uses: ["Antimalarial properties (bark)", "Wound healing", "Diarrhoea treatment", "Nutritious edible fruit", "Timber and shade tree"],
    warnings: ["Raw bark may cause stomach upset", "Large quantities of unripe fruit may cause constipation", "Bark preparations should be used with caution"],
    traditional_uses: ["Fruits eaten fresh and dried across savanna communities", "Bark boiled for traditional malaria treatment in East Africa", "Wood used for carving and tool handles due to hardness", "Leaves used as forage for livestock during dry season"],
    local_names: { Zulu: "umKhiwane", Shona: "Chakata", Afrikaans: "Jakkalsbessie", Swahili: "Mbirimbi" },
  },
  {
    id: "buffalo-thorn",
    name_common: "Buffalo Thorn",
    name_scientific: "Ziziphus mucronata",
    image_url: null,
    safety_status: "Safe",
    uses: ["Wound and skin infection treatment (leaves)", "Digestive ailments (root)", "Reduction of swelling", "Edible fruit and seeds", "Fever management"],
    warnings: ["Seeds should not be consumed — may be toxic in large quantities", "Root bark may cause nausea if consumed in excess", "Thorns can cause serious puncture wounds"],
    traditional_uses: ["Sacred tree in Zulu culture — associated with ancestral spirits", "Used in burial rites to guide spirits of the departed home", "Leaves applied as poultice to wounds and swellings", "Fruit eaten and used in traditional beer brewing"],
    local_names: { Zulu: "umLahlankosi", Shona: "Muchakata", Afrikaans: "Blinkblaar-wag-'n-bietjie", Tswana: "Mokgalo" },
  },
];
