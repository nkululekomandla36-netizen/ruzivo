...
const knowledgeMap: Record<string, LocalPlantKnowledge> = {
  ...
  "nigella sativa": {
    traditionalKnowledge: [
      "Revered in Islamic medicine as 'Habbatus Sauda' — mentioned in prophetic traditions as a remedy for everything except death.",
      "Used for over 2,000 years across North Africa, the Middle East, and East Africa along trade routes.",
      "Ancient Egyptians used black seed oil — a bottle was found in Tutankhamun's tomb.",
    ],
    traditionalUses: [
      "Seeds mixed with honey and consumed for respiratory conditions including asthma and bronchitis.",
      "Oil applied to scalp to promote hair growth and treat dandruff in North African communities.",
      "Used across the Sahel region for digestive complaints, bloating, and intestinal parasites.",
      "Ground seeds applied as a poultice for skin conditions including eczema and psoriasis.",
    ],
    safetyNotes: [
      "Avoid large or concentrated doses during pregnancy — may stimulate uterine contractions.",
      "May enhance the effect of blood-thinning medications including warfarin.",
      "Possible interaction with diabetes medications; monitor blood sugar closely.",
      "Not recommended for children under 2 years without medical advice.",
    ],
    ecology: [
      "Native to Southwest Asia and the Mediterranean; naturalised in North and East Africa.",
      "Grows in well-drained, sandy soils in warm, dry climates with full sun.",
      "Annual herb reaching 20–30 cm; delicate blue-white flowers attract pollinators.",
    ],
    conservation: [
      "Widely cultivated globally; not threatened in the wild.",
      "Commercially grown across Ethiopia, Egypt, and Morocco for seed export.",
    ],
    nutritionalProfile: [
      "Protein: seeds contain approximately 21% protein — a rich plant-based protein source.",
      "Fats: rich in polyunsaturated fatty acids including linoleic acid (omega-6).",
      "Minerals: significant iron, zinc, calcium, and potassium content in seeds.",
      "Fiber: seeds contain 12% dietary fiber supporting digestive health.",
    ],
    activeCompounds: [
      "Thymoquinone: primary bioactive compound with antioxidant and anti-inflammatory properties.",
      "Carvacrol: volatile compound with documented antimicrobial activity.",
      "Nigellone: compound associated with antihistamine and bronchodilator effects.",
      "Fixed oils: linoleic, oleic, and palmitic acids in the seed oil.",
      "Alkaloids: nigellidine and nigellicine identified in seed extracts.",
    ],
    healthBenefits: [
      "Thymoquinone associated with immune modulation and antioxidant protection in research.",
      "Traditional and emerging research supports use for respiratory conditions including asthma.",
      "Anti-inflammatory compounds associated with reduction of chronic inflammatory markers.",
      "Research suggests potential blood sugar-lowering effects in diabetic models.",
    ],
  },
  "curcuma longa": {
    traditionalKnowledge: [
      "Used in East African coastal communities for centuries, arriving via Indian Ocean trade routes.",
      "Known as 'Manjano' in Swahili — integrated into Swahili cooking and healing traditions.",
      "Ancient use documented in Ayurvedic medicine spreading to African communities via trade.",
    ],
    traditionalUses: [
      "Root paste applied to wounds, cuts, and skin irritations for antimicrobial protection.",
      "Tea brewed from fresh or dried root for stomach aches and liver complaints.",
      "Added to food as both a flavouring spice and a daily preventive medicine.",
      "Used in East African communities for menstrual pain and fever reduction.",
    ],
    safetyNotes: [
      "High doses may cause stomach upset, nausea, or diarrhoea.",
      "May enhance the effect of blood-thinning medications — avoid before surgery.",
      "Can stain skin and fabrics permanently yellow — use with care.",
      "Possible interaction with diabetes medications; monitor blood sugar.",
    ],
    ecology: [
      "Tropical plant native to South Asia; cultivated across East and West Africa.",
      "Requires warm, humid conditions and rich, well-drained loamy soil.",
      "Grows as a perennial rhizome; produces striking yellow-orange underground stems.",
    ],
    conservation: [
      "Widely cultivated; not threatened globally.",
      "Increasingly grown commercially in East Africa (Tanzania, Kenya) for export.",
    ],
    nutritionalProfile: [
      "Vitamins: contains vitamins C, E, and K; also B6 in small amounts.",
      "Minerals: manganese, iron, and potassium present in meaningful quantities.",
      "Fiber: dried turmeric powder contains approximately 21% dietary fiber.",
      "Protein: modest protein content (~9% in dried powder).",
    ],
    activeCompounds: [
      "Curcuminoids: curcumin, demethoxycurcumin, and bisdemethoxycurcumin — primary anti-inflammatory compounds.",
      "Volatile oils: turmerone, atlantone, and zingiberene giving the characteristic aroma.",
      "Tannins: mild astringent tannins with antimicrobial properties.",
      "Polyphenols: phenolic compounds contributing to antioxidant activity.",
    ],
    healthBenefits: [
      "Curcumin extensively researched for anti-inflammatory and antioxidant effects.",
      "Traditional and clinical research supports digestive health and liver support uses.",
      "Associated with joint health support; research ongoing for arthritis conditions.",
      "Antimicrobial properties support traditional use for wound care and infection prevention.",
    ],
  },
  "zingiber officinale": {
    traditionalKnowledge: [
      "One of the oldest spices traded along East African coastal routes for over 1,000 years.",
      "Documented in Swahili medicine as 'Tangawizi' — a household remedy across generations.",
      "Used in West African communities for headaches and muscle pain relief.",
    ],
    traditionalUses: [
      "Fresh root boiled with lemon and honey for colds, flu, and sore throats across Africa.",
      "Ginger tea consumed for nausea, vomiting, and motion sickness.",
      "Root ground into paste and applied to temples for headache relief.",
      "Used in postpartum care across East Africa to warm the body and restore circulation.",
    ],
    safetyNotes: [
      "Large amounts may cause heartburn, mouth irritation, or stomach discomfort.",
      "Avoid before surgery — has mild blood-thinning effect.",
      "Rare allergic reactions reported in sensitive individuals.",
      "May interact with anticoagulant medications; consult a physician.",
    ],
    ecology: [
      "Tropical plant requiring warm, humid climate and rich, well-drained soil.",
      "Cultivated widely across East and West Africa; grows best in partial shade.",
      "Rhizome plant producing leafy shoots up to 1 metre tall; rarely flowers in cultivation.",
    ],
    conservation: [
      "Widely cultivated globally; no conservation concerns.",
      "Major commercial crop in Nigeria, Uganda, and Ghana.",
    ],
    nutritionalProfile: [
      "Vitamins: contains vitamin C, B6, and folate in fresh root.",
      "Minerals: magnesium, manganese, potassium, and copper present.",
      "Protein: small amounts of protein (~1.8g/100g fresh root).",
      "Carbohydrates: starchy rhizome with ~18% carbohydrates in fresh root.",
    ],
    activeCompounds: [
      "Gingerols: primary pungent compounds with anti-inflammatory and anti-nausea properties.",
      "Shogaols: formed from gingerols on drying — more potent anti-inflammatory effect.",
      "Zingerone: contributes to the warm, spicy flavour and antioxidant activity.",
      "Paradols: compounds with antioxidant and anti-cancer research interest.",
      "Volatile oils: zingiberene, bisabolene, and borneol giving the aromatic profile.",
    ],
    healthBenefits: [
      "Gingerols well-documented for anti-nausea effect — effective for morning and motion sickness.",
      "Anti-inflammatory compounds associated with reduced muscle soreness after exercise.",
      "Traditional use for digestive health supported by research on gastric motility.",
      "Antioxidant profile associated with protection against oxidative stress.",
    ],
  },
  "vitellaria paradoxa": {
    traditionalKnowledge: [
      "Sacred tree of the West African Sahel — traditionally never cut down by farming communities.",
      "Shea butter production is a centuries-old women's economic tradition across the Sahel.",
      "Central to cultural identity in Burkina Faso, Mali, Ghana, and surrounding regions.",
    ],
    traditionalUses: [
      "Shea butter applied to newborns' skin immediately after birth in many West African communities.",
      "Used as cooking fat across the Sahel where other oils are unavailable.",
      "Applied to joints and muscles for arthritis and rheumatism relief.",
      "Butter used to condition and protect hair in dry conditions.",
    ],
    safetyNotes: [
      "Possible allergic reaction in individuals with tree nut sensitivities.",
      "Raw shea butter may cause skin breakouts in acne-prone individuals.",
      "Use of unrefined shea butter for cooking is traditional but high in saturated fat.",
    ],
    ecology: [
      "Native to the Sahel and Sudan savanna zones of West and Central Africa.",
      "Grows in semi-arid woodland and parkland — slow-growing tree reaching 15–25 metres.",
      "Produces fruits rich in oil; fruit pulp is edible with a sweet flavour.",
      "Keystone species of the Sahel agroforestry system — maintains soil moisture and fertility.",
    ],
    conservation: [
      "Not globally threatened but pressure from agriculture and deforestation is significant.",
      "Protected by traditional taboo in many communities — considered bad luck to fell.",
      "Increasingly valued in international cosmetics market — supporting conservation incentives.",
    ],
    nutritionalProfile: [
      "Fats: shea butter is approximately 50% stearic acid and 40% oleic acid — highly moisturising lipid profile.",
      "Vitamins: unrefined shea butter contains vitamins A, E, and F.",
      "Phytosterols: significant beta-sitosterol and other plant sterols with skin-protective properties.",
      "Triterpenes: lupane-type triterpenes with documented anti-inflammatory effects.",
    ],
    activeCompounds: [
      "Stearic acid: saturated fatty acid forming a protective barrier on skin surface.",
      "Oleic acid: monounsaturated fatty acid supporting skin moisture and elasticity.",
      "Vitamin E (tocopherols): powerful antioxidant protecting skin cells from oxidative damage.",
      "Lupeol: triterpene with anti-inflammatory and antimicrobial properties.",
      "Catechins: phenolic antioxidants in the fruit pulp.",
    ],
    healthBenefits: [
      "Vitamin E and fatty acid profile associated with skin moisturisation, healing, and UV protection.",
      "Anti-inflammatory compounds associated with relief of eczema, dermatitis, and dry skin.",
      "Traditional and cosmetic use for wound healing supported by antimicrobial and emollient properties.",
      "Phytosterol content associated with reduction of skin inflammation in research models.",
    ],
  },
  "garcinia kola": {
    traditionalKnowledge: [
      "Sacred in West and Central African ceremonial life — offered as a symbol of respect and hospitality.",
      "Called 'the bitter truth' — given to guests and elders at important gatherings.",
      "Traditional knowledge of Bitter Kola as an antidote and protective medicine spans generations.",
    ],
    traditionalUses: [
      "Chewed before meals to stimulate appetite and aid digestion.",
      "Used by traditional healers for chest infections, coughs, and bronchitis.",
      "Seeds chewed as a natural remedy for throat infections and tonsillitis.",
      "Used in West Africa as an antidote for plant poisoning and food poisoning.",
    ],
    safetyNotes: [
      "High consumption may cause increased heart rate and palpitations.",
      "Avoid when taking hypertension medication — may interact with blood pressure drugs.",
      "Not recommended during pregnancy due to high caffeine-like compound content.",
      "Excessive use may cause insomnia and anxiety.",
    ],
    ecology: [
      "Native to West and Central African tropical rainforests.",
      "Evergreen tree growing to 12 metres in moist, lowland forest environments.",
      "Fruits are round, yellow-orange, containing 2–4 seeds surrounded by pulp.",
      "Plays important ecological role as food source for forest animals.",
    ],
    conservation: [
      "Increasingly threatened by habitat loss and over-harvesting.",
      "Listed as vulnerable in parts of its range due to deforestation.",
      "Cultivation programmes underway in Nigeria and Ghana to reduce wild harvesting pressure.",
    ],
    nutritionalProfile: [
      "Protein: seeds contain approximately 3–6% protein.",
      "Biflavonoids: high concentration of plant flavonoids — among the richest known sources.",
      "Xanthones: unique polycyclic compounds found in seeds and bark.",
      "Fiber: moderate fiber content in seed coat.",
    ],
    activeCompounds: [
      "Bioflavonoids: kolaviron — a complex of biflavonoids unique to Garcinia kola with strong antioxidant properties.",
      "Benzophenones: garcinol — a potent antioxidant and anti-inflammatory compound.",
      "Xanthones: α-mangostin and related compounds with antimicrobial and antitumour research interest.",
      "Tannins: condensed tannins contributing to astringent and antimicrobial properties.",
    ],
    healthBenefits: [
      "Kolaviron extensively researched for antioxidant, anti-inflammatory, and hepatoprotective effects.",
      "Antimicrobial compounds associated with traditional use for respiratory and throat infections.",
      "Research interest in garcinol for anti-inflammatory and potential anti-cancer properties.",
      "Traditional use for gastrointestinal health supported by tannin and fiber content.",
    ],
  },
  "annona muricata": {
    traditionalKnowledge: [
      "Introduced to Africa from the Americas but rapidly integrated into tropical African healing traditions.",
      "Used across West, East, and Central Africa as a fever and infection remedy.",
      "Leaf tea widely known across sub-Saharan Africa as a calming bedtime drink.",
    ],
    traditionalUses: [
      "Leaves boiled for tea — used as fever reducer and calming remedy for adults and children.",
      "Fruit pulp given to patients recovering from illness for nutritional support.",
      "Bark and root preparations used in some West African traditions for intestinal worms.",
      "Fresh leaves applied to the forehead for headache and fever relief.",
    ],
    safetyNotes: [
      "Seeds are toxic — never consume seeds under any circumstances.",
      "May significantly lower blood pressure — avoid with antihypertensive medication.",
      "Avoid in Parkinson's disease — annonacin compound may worsen neurological symptoms.",
      "Not recommended during pregnancy.",
    ],
    ecology: [
      "Tropical tree native to the Americas; widely cultivated across equatorial Africa.",
      "Requires warm, humid climate and deep, fertile, well-drained soil.",
      "Grows 5–10 metres tall; flowers and fruits year-round in tropical conditions.",
    ],
    conservation: [
      "Widely cultivated; no global conservation concerns.",
      "Important commercial fruit crop in East and West Africa.",
    ],
    nutritionalProfile: [
      "Vitamins: excellent source of vitamin C (~20mg/100g); also B1, B2, and B3.",
      "Minerals: significant potassium, magnesium, and phosphorus in fruit pulp.",
      "Fiber: fruit pulp contains 3.3% dietary fiber supporting digestive health.",
      "Carbohydrates: ~16% carbohydrates in ripe fruit — moderate glycaemic load.",
    ],
    activeCompounds: [
      "Acetogenins: annonaceous acetogenins — unique compounds with strong cytotoxic research interest.",
      "Alkaloids: reticuline and other isoquinoline alkaloids with sedative properties.",
      "Flavonoids: quercetin, rutin, and kaempferol with antioxidant activity.",
      "Tannins: astringent tannins in leaf extracts contributing to antimicrobial properties.",
      "Annonacin: neurotoxic acetogenin concentrated in seeds and unripe fruit — avoid.",
    ],
    healthBenefits: [
      "High vitamin C content associated with immune support and antioxidant protection.",
      "Alkaloid compounds associated with sedative and relaxation effects in traditional use.",
      "Acetogenins subject of cancer research interest — do not interpret as proven treatment.",
      "Anti-inflammatory flavonoids support traditional use for fever and infection management.",
    ],
  },
  "cymbopogon citratus": {
    traditionalKnowledge: [
      "Widely used across tropical Africa in both cuisine and healing — called 'fever grass' in many traditions.",
      "A common household remedy plant grown near homes across East and West Africa.",
      "Used in spiritual and ritual cleansing practices in some African communities.",
    ],
    traditionalUses: [
      "Fresh leaves boiled for tea — used for stomach aches, fever, and headaches.",
      "Burned as a natural insect repellent around homes and sleeping areas.",
      "Steam inhalation of lemongrass leaves used for sinus congestion and colds.",
      "Crushed fresh leaves applied to skin for insect bites and rashes.",
    ],
    safetyNotes: [
      "Essential oil may cause skin and eye irritation — always dilute before topical use.",
      "Large quantities during pregnancy should be avoided — may stimulate uterine contractions.",
      "Possible photosensitivity reaction when oil is applied before sun exposure.",
    ],
    ecology: [
      "Tropical perennial grass native to South Asia; naturalised across warm regions of Africa.",
      "Grows in clumps up to 2 metres tall; prefers full sun and moderate rainfall.",
      "Tolerates a wide range of soils; drought-tolerant once established.",
      "Fast-growing and productive — can be harvested multiple times per year.",
    ],
    conservation: [
      "Not threatened; widely cultivated and commercially produced.",
      "Important essential oil crop in East Africa (Tanzania, Kenya, Uganda).",
    ],
    nutritionalProfile: [
      "Vitamins: small amounts of vitamins A, C, and B-complex in fresh leaves.",
      "Minerals: iron, manganese, copper, and zinc present in leaf tissue.",
      "Essential oils: 0.5–1.5% volatile oil content — primary source of active compounds.",
      "Fiber: moderate fiber content in dried leaf preparations.",
    ],
    activeCompounds: [
      "Citral (neral + geranial): primary volatile compound with antimicrobial and sedative properties.",
      "Limonene: terpene with anti-inflammatory and antioxidant properties.",
      "Geraniol: fragrant terpene with documented antimicrobial activity.",
      "Flavonoids: luteolin and quercetin with antioxidant and anti-inflammatory effects.",
      "Phenolic acids: chlorogenic acid contributing to antioxidant activity.",
    ],
    healthBenefits: [
      "Citral compounds associated with antimicrobial activity against common bacterial and fungal pathogens.",
      "Calming and anxiolytic effects linked to volatile oil compounds in traditional use.",
      "Anti-inflammatory flavonoids support traditional use for fever and inflammation.",
      "Antioxidant profile associated with protection against oxidative stress-related conditions.",
    ],
  },
  "psidium guajava": {
    traditionalKnowledge: [
      "Introduced from the Americas to Africa but deeply embedded in local healing traditions for centuries.",
      "Leaves are one of the most commonly used household remedies for stomach ailments across Africa.",
      "Known as a first-aid plant — leaves available year-round for emergency use.",
    ],
    traditionalUses: [
      "Young leaves boiled and drunk for diarrhoea and dysentery across East and West Africa.",
      "Leaf paste applied to wounds, ulcers, and skin infections as an antimicrobial dressing.",
      "Young leaves chewed for toothache and gum disease in many African communities.",
      "Fruit consumed for vitamin C deficiency — widely used as a natural supplement.",
    ],
    safetyNotes: [
      "Excessive fruit consumption may cause constipation in sensitive individuals.",
      "Seeds can irritate the digestive tract — remove for sensitive stomachs.",
      "Leaf tea should not replace medical treatment for severe or bloody diarrhoea.",
    ],
    ecology: [
      "Tropical tree native to Central America; naturalised and cultivated across warm Africa.",
      "Grows in diverse soils and climates; tolerates drought and poor soil conditions.",
      "Fast-growing tree to 8 metres; fruits year-round in tropical climates.",
      "Important fruit tree for birds, bats, and wildlife in African gardens.",
    ],
    conservation: [
      "Not threatened; widely cultivated across Africa and globally.",
      "Considered invasive in some regions — spreads readily along waterways.",
    ],
    nutritionalProfile: [
      "Vitamins: exceptionally high vitamin C (~228mg/100g) — 4× more than oranges.",
      "Vitamins: also contains vitamins A, B3 (niacin), B6, and folate.",
      "Minerals: potassium, magnesium, and phosphorus in significant quantities.",
      "Fiber: fruit pulp contains 5.4% dietary fiber — supports digestive regularity.",
    ],
    activeCompounds: [
      "Quercetin: powerful antioxidant flavonoid in leaves — primary antimicrobial compound.",
      "Guaijaverin: flavonoid with documented antibacterial activity against oral pathogens.",
      "Tannins: condensed tannins responsible for antidiarrhoeal and astringent properties.",
      "Lycopene: carotenoid antioxidant in pink-fleshed guava fruits.",
      "Vitamin C (ascorbic acid): potent antioxidant and immune system cofactor.",
    ],
    healthBenefits: [
      "Quercetin and tannins associated with antidiarrhoeal effect — supports traditional use.",
      "Vitamin C content among the highest of any common tropical fruit — immune support.",
      "Flavonoid and antioxidant profile associated with cardiovascular health research.",
      "Antimicrobial compounds support traditional use for dental health and skin infections.",
    ],
  },
  "tamarindus indica": {
    traditionalKnowledge: [
      "Believed to be native to tropical East Africa — one of the continent's oldest cultural trees.",
      "Used across Africa for food and medicine for thousands of years before global trade.",
      "The tamarind tree is a gathering place and landmark tree in many African villages.",
    ],
    traditionalUses: [
      "Pulp dissolved in water and consumed as a cooling drink for fever and heat exhaustion.",
      "Used across the Sahel and East Africa as a natural laxative for constipation.",
      "Seeds ground and applied to skin inflammations, sores, and insect stings.",
      "Leaves used in traditional cooking and as a mild fever remedy for children.",
    ],
    safetyNotes: [
      "Avoid excessive amounts when taking aspirin or blood-thinning medications.",
      "Large quantities may cause loose stools or diarrhoea.",
      "Very sour — may aggravate acid reflux or gastric ulcer symptoms.",
    ],
    ecology: [
      "Long-lived tropical tree native to the dry savanna zones of East Africa.",
      "Thrives in hot, arid and semi-arid conditions; drought-tolerant once established.",
      "Can live for over 200 years; provides shade and wildlife habitat in savanna ecosystems.",
      "Fruit pods mature in the dry season — important food source when other fruits are scarce.",
    ],
    conservation: [
      "Not threatened globally; widely cultivated across Africa, Asia, and the Americas.",
      "Ancient trees of cultural significance are protected in some communities.",
    ],
    nutritionalProfile: [
      "Vitamins: excellent source of B1 (thiamine) and B3 (niacin); also vitamin C.",
      "Minerals: significant tartrate, potassium, phosphorus, iron, and magnesium.",
      "Carbohydrates: high sugar content in ripe pulp (~57g/100g) — concentrated energy source.",
      "Fiber: 5.1% dietary fiber in dried pulp — supports digestive health.",
    ],
    activeCompounds: [
      "Tartaric acid: primary organic acid responsible for sour flavour and laxative properties.",
      "Flavonoids: procyanidins, catechins, and epicatechins with antioxidant activity.",
      "Hydroxycinnamic acids: caffeic and ferulic acids contributing to antioxidant profile.",
      "Saponins: trace saponins with mild antimicrobial properties.",
      "Tannins: condensed tannins with astringent and antimicrobial properties.",
    ],
    healthBenefits: [
      "Tartaric acid associated with natural laxative effect — supports traditional use for constipation.",
      "Antioxidant polyphenols associated with anti-inflammatory and cardiovascular protective effects.",
      "B-vitamin content supports energy metabolism and nervous system health.",
      "Antimicrobial compounds support traditional use for wound cleaning and infections.",
    ],
  },
  "agave americana": {
    traditionalKnowledge: [
      "Introduced from the Americas to Africa in the 16th–17th century via Portuguese and Spanish trade routes.",
      "Rapidly adopted by African communities for wound treatment and fiber production.",
      "Used as living fence and drought barrier plant in arid African farming systems.",
    ],
    traditionalUses: [
      "Fresh sap applied to wounds and cuts as a natural antimicrobial dressing.",
      "Leaves split and used as natural bandages in emergency field situations.",
      "Fibers extracted from leaves used for rope-making, baskets, and crafts.",
      "Fermented sap consumed as a traditional alcoholic beverage ('pulque') in some regions.",
    ],
    safetyNotes: [
      "Raw sap can cause severe skin and eye irritation — handle with protective gloves.",
      "Not for internal use without proper processing and medical guidance.",
      "Toxic to pets and livestock — keep animals away from the plant.",
      "Sharp leaf spines can cause serious puncture injuries — extreme care required.",
    ],
    ecology: [
      "Desert succulent native to Mexico and Central America; naturalised across dry Africa.",
      "Thrives in arid and rocky soils with excellent drainage; extremely drought-tolerant.",
      "Slow-growing rosette plant flowering only once after 10–30 years (hence 'Century Plant').",
      "Important pioneer plant stabilising eroded soils in dry African landscapes.",
    ],
    conservation: [
      "Not threatened; widely naturalised and considered invasive in some African regions.",
      "Spreads aggressively in dry areas; management required near native vegetation.",
    ],
    nutritionalProfile: [
      "Fructans: agave hearts (piñas) are rich in fructooligosaccharides — prebiotic fiber.",
      "Saponins: steroidal saponins present throughout plant tissues.",
      "Agavins: plant-specific fructans with potential low-glycaemic sweetening properties.",
    ],
    activeCompounds: [
      "Saponins: hecogenin and agavosaponin — steroidal saponins with antimicrobial properties.",
      "Polyphenols: caffeic acid and other phenolic acids in sap and leaf extracts.",
      "Fructooligosaccharides: prebiotic fibers with gut health-supporting properties.",
      "Sterols: beta-sitosterol and campesterol with anti-inflammatory properties.",
    ],
    healthBenefits: [
      "Saponins associated with antimicrobial activity supporting traditional wound-care use.",
      "Fructooligosaccharides associated with prebiotic gut health benefits in research.",
      "Polyphenol profile associated with antioxidant protection against oxidative stress.",
      "Traditional wound-healing use supported by antimicrobial and astringent compounds.",
    ],
  },
  "pelargonium sidoides": {
    traditionalKnowledge: [
      "Knowledge of this plant's healing properties held by Zulu and Basotho healers for centuries.",
      "Called 'Umckaloabo' in Zulu — meaning 'heavy cough' — describing its primary traditional use.",
      "Knowledge was shared with European medicine in the 1800s by Charles Henry Stevens, who was treated by a Basotho healer.",
    ],
    traditionalUses: [
      "Root preparations used by Zulu and Basotho healers for tuberculosis, chest infections, and coughs.",
      "Boiled root decoctions consumed for respiratory infections and persistent cough.",
      "Used in Southern African communities for diarrhoea, liver, and kidney conditions.",
      "Leaves applied topically in some communities for wound care and skin infections.",
    ],
    safetyNotes: [
      "Very rare cases of liver toxicity reported with prolonged high-dose use.",
      "Avoid in autoimmune conditions (lupus, MS, rheumatoid arthritis) — may stimulate immune activity.",
      "Not well-studied in children under 6 years — use with medical guidance.",
      "Possible interaction with immunosuppressant medications.",
    ],
    ecology: [
      "Native to the Drakensberg foothills and grasslands of South Africa and Lesotho.",
      "Grows in rocky, well-drained soils of high-altitude grasslands and montane areas.",
      "Small perennial shrub 20–50 cm tall with characteristic dark red flowers.",
      "Increasing commercial demand has placed pressure on wild populations.",
    ],
    conservation: [
      "Increasing global commercial demand has created over-harvesting pressure in the wild.",
      "Listed as a species of concern in parts of South Africa due to root harvesting.",
      "Cultivation and responsible sourcing programmes are being developed.",
    ],
    nutritionalProfile: [
      "Coumarins: significant coumarin content — bioactive compounds rather than primary nutrients.",
      "Flavonoids: concentrated in root tissue — high antioxidant flavonoid content.",
      "Phenolics: hydroxybenzyl alcohol and related compounds unique to this species.",
    ],
    activeCompounds: [
      "Umckalin: specific coumarin compound associated with antiviral activity.",
      "Pelargonium-specific phenolics: hydroxybenzyl alcohol derivatives with antimicrobial properties.",
      "Flavonoids: catechins and procyanidins contributing to antioxidant and immune-modulating effects.",
      "Polyphenols: oligomeric proanthocyanidins associated with immune stimulation.",
    ],
    healthBenefits: [
      "Coumarin compounds associated with antiviral activity against common respiratory viruses.",
      "Clinical evidence supports use for acute bronchitis and upper respiratory tract infections.",
      "Immune-stimulating polyphenols associated with reduced duration of cold symptoms in trials.",
      "Antimicrobial activity documented against common respiratory bacterial pathogens.",
    ],
  },
  "hoodia gordonii": {
    traditionalKnowledge: [
      "Used by San Bushmen (Khoisan people) as a survival tool on multi-day hunts for thousands of years.",
      "Knowledge of Hoodia was one of the most guarded secrets of San survival in the Kalahari.",
      "The San's rights to benefit from Hoodia commercialisation were formally recognised in 2003 through a groundbreaking agreement.",
    ],
    traditionalUses: [
      "Stalks cut and chewed on long hunts to suppress hunger and thirst for extended periods.",
      "Used as a survival food during famine and drought by Khoisan communities.",
      "Juice applied to minor wounds and cuts in the field as a natural remedy.",
      "A symbol of San identity and survival knowledge — not shared with outsiders for centuries.",
    ],
    safetyNotes: [
      "Can dangerously suppress thirst and hunger signals — serious dehydration risk in hot conditions.",
      "Not safe for people with malnutrition, eating disorders, or low body weight.",
      "Limited and inconsistent clinical research in humans — effects poorly documented.",
      "Not recommended without medical supervision for weight management.",
    ],
    ecology: [
      "Native to the Kalahari Desert, Namib, and Karoo regions of Southern Africa.",
      "Succulent cactus-like plant (actually a milkweed family member) growing in hot, arid scrublands.",
      "Produces star-shaped flowers with a distinctive carrion smell to attract fly pollinators.",
      "Grows extremely slowly; highly adapted to survive months without rainfall.",
    ],
    conservation: [
      "Legally protected in South Africa, Botswana, and Namibia — harvesting requires permits.",
      "Wild populations threatened by over-collection for pharmaceutical and supplement trade.",
      "Commercial cultivation underway but slow due to the plant's extremely slow growth rate.",
    ],
    nutritionalProfile: [
      "Oxypregnane glycosides: the primary bioactive compounds rather than conventional nutrients.",
      "Water: very high water content making it useful for hydration despite bitter taste.",
      "Fiber: significant fiber in stalk tissue.",
    ],
    activeCompounds: [
      "P57: oxypregnane steroidal glycoside — the compound proposed to explain appetite-suppressing effect.",
      "Pregnane glycosides: a class of steroid-related compounds unique to Hoodia species.",
      "Bitter principles: compounds contributing to the intensely bitter taste.",
    ],
    healthBenefits: [
      "P57 compound proposed to signal the brain of fullness — mechanism under ongoing research.",
      "Traditional use for hunger and thirst suppression is well-documented in San oral history.",
      "Research interest in appetite regulation — clinical evidence remains limited and mixed.",
      "Not validated as safe or effective for weight loss in rigorous clinical trials.",
    ],
  },
  "kigelia africana": {
    traditionalKnowledge: [
      "One of the most culturally significant trees in Central, East, and Southern Africa.",
      "Sacred to many communities — associated with rain-making ceremonies and protection rituals.",
      "Large hanging fruits (resembling sausages) make it unmistakable and memorable across the continent.",
    ],
    traditionalUses: [
      "Bark boiled for skin conditions including eczema, psoriasis, boils, and sores across East Africa.",
      "Used in Southern Africa for rheumatism, toothache, and general pain relief.",
      "Dried and fermented fruit used as an additive to traditional beer in Zimbabwe and Zambia.",
      "Fruit extract applied to skin for anti-ageing and wound healing in traditional cosmetics.",
    ],
    safetyNotes: [
      "Raw, fresh fruit is toxic — causes vomiting, blistering, and severe irritation.",
      "Only dried, fermented or processed fruit preparations have traditional medicinal use.",
      "Topical preparations should be patch-tested — may cause skin irritation in sensitive individuals.",
      "Never consume raw fruit or unprocessed preparations without expert guidance.",
    ],
    ecology: [
      "Native to tropical and subtropical Africa — found from Senegal to South Africa.",
      "Large deciduous tree growing to 20 metres; occurs in woodland, savanna, and riverine forests.",
      "Fruits weigh up to 10 kg and hang on long stalks — adapted for dispersal by elephants and hippos.",
      "Bat-pollinated flowers open at night — an important night-time food source for bats.",
    ],
    conservation: [
      "Not currently threatened; widespread across its range.",
      "Sacred status in many communities provides cultural protection.",
      "Harvesting of bark can damage trees — sustainable extraction recommended.",
    ],
    nutritionalProfile: [
      "Glycosides: iridoid glycosides are the primary bioactive compounds.",
      "Fatty acids: seed oil contains oleic and linoleic acids.",
      "Tannins: high tannin content in bark and fruit contributing to antimicrobial properties.",
    ],
    activeCompounds: [
      "Kigelinone: a naphthoic acid compound with antibacterial and antifungal properties.",
      "Iridoids: verminoside and minecoside — anti-inflammatory and antitumour research interest.",
      "Coumarins: isocoumarins with documented antimicrobial activity.",
      "Ferulic acid: a hydroxycinnamic acid with antioxidant and anti-inflammatory properties.",
      "Sterols: stigmasterol and beta-sitosterol with anti-inflammatory properties.",
    ],
    healthBenefits: [
      "Kigelinone documented with antibacterial and antifungal activity — supports wound care use.",
      "Iridoid compounds associated with anti-inflammatory effects supporting traditional use.",
      "Research interest in skin cancer applications due to cytotoxic iridoid compounds.",
      "Antioxidant ferulic acid associated with skin-protective and anti-ageing effects.",
    ],
  },
  "diospyros mespiliformis": {
    traditionalKnowledge: [
      "One of the most important indigenous fruit trees of the African savanna woodland.",
      "Found from West to East and Southern Africa — integral to local food security for centuries.",
      "Fruits ripen in the dry season — a vital food source when other foods are scarce.",
    ],
    traditionalUses: [
      "Ripe fruits eaten fresh and dried for storage and consumption throughout the year.",
      "Bark boiled and consumed for malaria treatment in East African communities.",
      "Leaves applied as poultice for skin infections and wound healing.",
      "Root and bark decoctions used for diarrhoea and stomach ailments across Southern Africa.",
    ],
    safetyNotes: [
      "Raw bark preparations may cause stomach upset — use with caution.",
      "Large quantities of unripe fruit can cause constipation.",
      "Bark preparations should be used at low doses and not for extended periods.",
    ],
    ecology: [
      "Medium to large deciduous tree (8–20 metres) of savanna woodland across sub-Saharan Africa.",
      "Grows in deep, well-drained sandy soils; drought-tolerant once established.",
      "Important food tree for birds, mammals, and insects; fruits consumed by elephants.",
      "Hard, dense wood used traditionally for carving tools and implements.",
    ],
    conservation: [
      "Not globally threatened; widespread across sub-Saharan Africa.",
      "Locally threatened in areas with high agricultural expansion and charcoal production.",
      "Traditionally protected in many communities — considered a food security tree.",
    ],
    nutritionalProfile: [
      "Carbohydrates: ripe fruit contains ~18% sugars — a natural energy source in season.",
      "Vitamins: vitamin C and beta-carotene in ripe fruit pulp.",
      "Minerals: calcium, iron, and potassium in the fruit.",
      "Tannins: high tannin content in unripe fruit and bark.",
    ],
    activeCompounds: [
      "Tannins: diospyrin and other naphtho-ortho-quinones — antimicrobial and antimalarial compounds.",
      "Naphthoquinones: including 7-methyljuglone with documented antifungal and antibacterial activity.",
      "Flavonoids: quercetin and related compounds in fruit and leaf extracts.",
      "Lupeol: triterpene with anti-inflammatory and antimalarial research interest.",
      "Diosphenol: terpenoid compound with antimicrobial properties.",
    ],
    healthBenefits: [
      "Naphthoquinone compounds associated with antimalarial activity — supports traditional use.",
      "Antimicrobial tannins and naphthoquinones support use for wound care and infections.",
      "Flavonoid antioxidants associated with anti-inflammatory and cardiovascular protective effects.",
      "Nutritious ripe fruit provides vitamins, minerals, and energy during the dry season.",
    ],
  },
  "ziziphus mucronata": {
    traditionalKnowledge: [
      "One of the most sacred trees in Zulu culture — strongly associated with ancestral spirits.",
      "Traditionally used in burial ceremonies — a branch brought back from the burial site to guide the spirit home.",
      "The name 'umLahlankosi' means 'where the chief was buried' in Zulu — reflecting its deep ceremonial role.",
    ],
    traditionalUses: [
      "Leaves applied as poultice for wounds, skin sores, and swellings across Southern Africa.",
      "Root decoctions used for stomach ailments, diarrhoea, and digestive complaints.",
      "Fruit eaten fresh and dried — an important bush food eaten by children and adults.",
      "Bark used for tanning leather in traditional leather-working communities.",
    ],
    safetyNotes: [
      "Seeds should not be consumed — may cause adverse effects in large quantities.",
      "Root bark may cause nausea if consumed in excess — use at low doses.",
      "The two-directional thorns (one forward, one backward) cause serious puncture wounds — handle with care.",
    ],
    ecology: [
      "Common tree of the African bushveld, woodland, and savanna from Egypt to South Africa.",
      "Medium deciduous tree to 8 metres with characteristic zigzag branches and paired thorns.",
      "Extremely drought-tolerant; grows in a wide range of soils including poor, rocky soils.",
      "Important food and shelter plant for birds, insects, and small mammals.",
    ],
    conservation: [
      "Not threatened; one of the most widespread trees in African bushveld.",
      "Sacred status in many Zulu communities provides strong cultural protection.",
      "Important pioneer species in land rehabilitation and agroforestry projects.",
    ],
    nutritionalProfile: [
      "Carbohydrates: ripe fruit contains 18–22% sugars — a significant bush food energy source.",
      "Vitamins: vitamin C present in fresh fruit; also vitamin A as beta-carotene.",
      "Minerals: calcium, iron, and phosphorus found in fruit and seed.",
      "Protein: modest protein content in seeds (~9%).",
    ],
    activeCompounds: [
      "Saponins: jujuboside A and B — triterpenoid saponins with sedative and adaptogenic properties.",
      "Flavonoids: spinosin and swertisin — flavone C-glycosides with anxiolytic and calming effects.",
      "Alkaloids: zizyphusine — an alkaloid unique to Ziziphus species.",
      "Cyclopeptide alkaloids: nummularine and mauritine with antimicrobial and anti-inflammatory properties.",
      "Tannins: condensed tannins contributing to wound-healing and antimicrobial properties.",
    ],
    healthBenefits: [
      "Flavone glycosides (spinosin, swertisin) associated with calming and sleep-supporting effects.",
      "Saponins associated with adaptogenic and immune-modulating properties in research.",
      "Antimicrobial tannins and alkaloids support traditional use for wound care and infections.",
      "Nutritious fruit provides natural sugars, vitamins, and minerals as a seasonal bush food.",
    ],
  },
};
